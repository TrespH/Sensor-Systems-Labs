...
/* USER CODE BEGIN PV */
uint16_t new_position = 0; //The newest acquired encoder position value
uint16_t old_position = 0; //Old acquired encoder position value

float    rpm = 0;		   //Final result of encoder velocity in rotations per minute
