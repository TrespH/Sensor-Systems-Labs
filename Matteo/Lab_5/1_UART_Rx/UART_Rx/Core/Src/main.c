...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LENGTH 1 // define how many bytes per time you want to send via UART
/* USER CODE END PD */
...
uint8_t RxData[LENGTH];	// stream variable
uint8_t row = 0;
char c[1];				// char stream variable
char string[16] = "";	// string to be composed
